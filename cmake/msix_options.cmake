...
option(USE_STATIC_MSIX "Build libmsix as a static library instead of shared. Default is 'off' (shared)" OFF)
...
if(USE_STATIC_MSIX)
    message(STATUS "\tMSIX library type   = STATIC")
else()
    message(STATUS "\tMSIX library type   = SHARED")
endif()
